                      ...
                      <div class="container-xxl d-flex h-100">
                        <ul class="menu-inner">
                          ...
                          <li class="menu-item">
                            ...
                            <ul class="menu-sub">
                              <li class="menu-item">
                                <a href="hardware.html" class="menu-link">
                              ...
                              <li class="menu-item">
                                <a href="car.html" class="menu-link">
                                  <i class="menu-icon tf-icons ti ti-menu-2"></i>
                              ...
                              <li class="menu-item">
                                <a href="Work-sites.html" class="menu-link">
                                  <i class="menu-icon tf-icons ti ti-square"></i>
                                  <div data-i18n="Work sites">مواقع العمل  </div>
                                </a>
                              </li>
                              <li class="menu-item">
                                <a href="GeneralSettings.html" class="menu-link">
                                  <i class="menu-icon tf-icons ti ti-arrows-maximize"></i>
                                  <div data-i18n="General Settings">الاعدادات العامة </div>
                                </a>
                              </li>
                                <li class="menu-item">
                                  <a href="Backup.html" class="menu-link">
                                    <i class="menu-icon tf-icons ti ti-arrows-maximize"></i>
                          ...
                          <li class="menu-item active">
                            ...
                            <ul class="menu-sub">
                              <li class="menu-item active">
                                <a href="Externalvisits.html" class="menu-link">
                                  <i class="menu-icon tf-icons ti ti-menu-2"></i>
                                  <div data-i18n="External visits">  الزيارات الخارجية</div>
                                </a>
                              </li>
                              <li class="menu-item">
                                <a href="Internal-visits.html" class="menu-link">
                                  <i class="menu-icon tf-icons ti ti-menu-2"></i>
                              ...
                              <li class="menu-item">
                                <a href="Personal-tasks.html" class="menu-link">
                                  <i class="menu-icon tf-icons ti ti-menu-2"></i>
                                  <div data-i18n="Personal tasks">   المهام الشخصية</div>
                                </a>
                              </li>
                              <li class="menu-item">
                                <a href="mission.html" class="menu-link">
                                  <i class="menu-icon tf-icons ti ti-menu-2"></i>
                          ...
                          <li class="menu-item">
                            ...
                            <ul class="menu-sub">
                              <li class="menu-item">
                                <a href="Maintenance-request.html" class="menu-link">
                              ...
                              <li class="menu-item">
                                ...
                                <ul class="menu-sub">
                                  ...
                                  <li class="menu-item ">
                                    <a href="Examination-definitions.html" class="menu-link">
                                      <div data-i18n="Examination-definitions"> تعريفات الفحص</div>
                                    </a>
                                    
                                  </li>
                                  <li class="menu-item">
                                    <a href="Periodic-inspection.html" class="menu-link">
                              ...
                              <li class="menu-item">
                                <a href="Add-Review-Maintenance.html" class="menu-link">
                                  <i class="menu-icon tf-icons ti ti-settings"></i>
                              ...
                              <li class="menu-item">
                                <a href="Request-spare-part.html" class="menu-link">
                                  <i class="menu-icon tf-icons ti ti-settings"></i>
                          ...
                          <li class="menu-item">
                            ...
                            <ul class="menu-sub">
                              <li class="menu-item">
                                <a href="mission-Reports.html" target="_blank" class="menu-link">
                              ...
                              <li class="menu-item">
                                <a
                                  href="Attendance-departure-report.html"
                                  target="_blank"
                                  class="menu-link">
                                  <i class="menu-icon tf-icons ti ti-file-description"></i>
                        ...
                        <li class="menu-item">
                          ...
                          <ul class="menu-sub">
                            ...
                            <li class="menu-item">
                              ...
                              <ul class="menu-sub">
                                <li class="menu-item">
                                  <a href="question.html" class="menu-link">
                                ...
                                <li class="menu-item">
                                  <a href="name-multiple-selection.html" class="menu-link">
                              ...
                              <li class="menu-item ">
                                ...
                                <ul  class="menu-sub">
                                  <li class="menu-item">
                                    <a href="create-Evaluations.html" class="menu-link">
                                      <div data-i18n="create-Evaluations"> اضافه تقييم</div>
                                    </a>
                                    </li>
                                    <li class="menu-item">
                                      <a href="all-Evaluations.html" class="menu-link">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                      ...
                      <div class="card-body py-2 px-md-4 px-2 card-widget-separator">
                        ...
                        <div class="row mx-0 d-flex flex-wrap  justify-content-between  mb-3 align-items-center pt-4">
                          ...
                          <div class="col text-end">
                            <a href="Externalvisits.html" class="btn btn-primary waves-effect waves-light btn-add"> مشاهدة الكل</a>
                   ...
                   <div class="card comonent-hader-top p-md-5 p-2 mt-4">
                    <form class="row component-form">
                      ...
                      <div class="col-12 col-lg-4 col-md-6  mb-3">
                        <label class="form-label" for="basic-default-number"> رقم التليفون 1</label>
                      ...
                      <div class="col-12 col-lg-8 col-md-6  mb-3">
                        <label class="form-label" for="basic-default-number"> رقم التليفون 2</label>
                        <input type="text" class="form-control" id="basic-default-number" placeholder="   رقم التليفون  ">
                      </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">اضافة الحالة   </h1>
              ...
              <div class="modal-body">
                <form class="row component-form align-items-end mx-0">
                  ...
                  <div class="col-12 col-lg-12  mb-3">
                    <label class="form-label" for="basic-name-hardware">   اسم الحالة   (عربى)</label>
                    <input type="text" class="form-control" id="basic-name-hardware">

                  </div>
                  <div class="col-12 col-lg-12  mb-3">
                    <label class="form-label" for="basic-name-hardware-e">    اسم الحالة  (انجيلزي)</label>
